...
//             <div onClick={()=>expand ? setExpand(false) : setExpand(true)} className='group relative flex items-center justify-center hover:bg-gray 500/20 transition-all
...
//       </div>
//       <div>
//         <div className={`flex items-center cursor-pointer group relative ${expand?"gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer":"h-10 w-10 rounded-lg hover:bg-gray-500/30"}`}>
...
//             <div className='relative w-max bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg'>
...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute 
    max md:h-screen ${expand ? 'p-4 w-64' : 'md:w-20 w-0 max-md:overflow-hidden'}`}
    >
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <Image
              src={
                expand ? assets.sidebar_close_icon : assets.sidebar_icon
              }
              alt=""
        ...
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ...
              : 'h-10 w-10 rounded-lg hover:bg-gray-500/30'
          }`}
        >
          <Image
